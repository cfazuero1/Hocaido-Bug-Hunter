let _caido_server_auth = require("@caido/server-auth");
let _urql_core = require("@urql/core");
let graphql_ws = require("graphql-ws");
let wonka = require("wonka");
let _urql_exchange_auth = require("@urql/exchange-auth");
require("graphql");
let zod = require("zod");
...
const caidoExtensionSchema = zod.z.discriminatedUnion("code", [
	zod.z.object({
		code: zod.z.literal(ErrorCodes.AUTHORIZATION),
		reason: zod.z.enum(AuthorizationErrorReason)
	}),
	zod.z.object({
		code: zod.z.literal(ErrorCodes.CLOUD),
		reason: zod.z.enum(CloudErrorReason)
	}),
	zod.z.object({
		code: zod.z.literal(ErrorCodes.INTERNAL),
...
const createAuthExchange = (options) => {
	const { auth } = options;
	return (0, _urql_exchange_auth.authExchange)(async (utils) => ({
...
const createFetchExchange = () => {
	return _urql_core.fetchExchange;
};
...
const createSubscriptionExchange = (options) => {
	...
	return (0, _urql_core.subscriptionExchange)({ forwardSubscription(request) {
		const input = {
			...request,
			query: request.query ?? ""
		};
...
var GraphQLClient = class {
	...
	*/
	subscribe(document, variables) {
		...
		return (0, wonka.toAsyncIterable)((0, wonka.pipe)(this.client.subscription(document, vars), (0, wonka.map)((result) => {
	...
	*/
	...
	getOrCreateAuthClient() {
		if (isAbsent(this.authClient)) {
			...
			this.authClient = new _caido_server_auth.AuthClient({
	...
	createApprover() {
		const auth = this.authOptions;
		if (isPresent(auth) && isPATAuth(auth)) return new _caido_server_auth.PATApprover({
			pat: auth.pat,
			fetch: this.requestOptions?.fetch,
			timeout: this.requestOptions?.timeout
		});
		const logger = this.logger;
		return new _caido_server_auth.BrowserApprover(auth?.onRequest ?? ((request) => {
...
const healthSchema = zod.z.object({
	name: zod.z.string(),
...
//#endregion
exports.AuthorizationUserError = AuthorizationUserError;
exports.BaseError = BaseError;
exports.Client = Client;
exports.CloudUserError = CloudUserError;
exports.Connection = Connection;
exports.ConsoleLogger = ConsoleLogger;
exports.EnvironmentInstance = EnvironmentInstance;
exports.EnvironmentSDK = EnvironmentSDK;
exports.FilterClauseKind = FilterClauseKind;
exports.FilterSDK = FilterSDK;
exports.FindingSDK = FindingSDK;
exports.GraphQLClient = GraphQLClient;
exports.HostedFileSDK = HostedFileSDK;
exports.InstanceNotReadyError = InstanceNotReadyError;
exports.InstanceSDK = InstanceSDK;
exports.InstanceSettingsSDK = InstanceSettingsSDK;
exports.NetworkUserError = NetworkUserError;
exports.NoDataUserError = NoDataUserError;
exports.NotFoundUserError = NotFoundUserError;
exports.OperationUserError = OperationUserError;
exports.OtherUserError = OtherUserError;
exports.PermissionDeniedUserError = PermissionDeniedUserError;
exports.PluginFunctionCallError = PluginFunctionCallError;
exports.PluginSDK = PluginSDK;
exports.PluginUserError = PluginUserError;
exports.ProjectSDK = ProjectSDK;
exports.ReadOnlyUserError = ReadOnlyUserError;
exports.ReplayCollectionSDK = ReplayCollectionSDK;
exports.ReplayCollectionsListBuilder = ReplayCollectionsListBuilder;
exports.ReplayEntry = ReplayEntry;
exports.ReplayEntrySDK = ReplayEntrySDK;
exports.ReplaySDK = ReplaySDK;
exports.ReplaySession = ReplaySession;
exports.ReplaySessionCollection = ReplaySessionCollection;
exports.ReplaySessionEntriesListBuilder = ReplaySessionEntriesListBuilder;
exports.ReplaySessionSDK = ReplaySessionSDK;
exports.ReplaySessionsListBuilder = ReplaySessionsListBuilder;
exports.RequestSDK = RequestSDK;
exports.RestClient = RestClient;
exports.RestRequestError = RestRequestError;
exports.ScopeSDK = ScopeSDK;
exports.StoreUserError = StoreUserError;
exports.Task = Task;
exports.TaskSDK = TaskSDK;
exports.TokenRefreshError = TokenRefreshError;
exports.UserSDK = UserSDK;
exports.WorkflowSDK = WorkflowSDK;
exports.WorkflowUserError = WorkflowUserError;
exports.from = from;
